...
SRC         :=	src/main.c	src/executor/resolve_path.c	src/utils/free_split.c src/parser/simple_parse.c \
				...
				src/expander/05_expand_utils_2.c src/utils/quote_removal.c src/build_commands/build_pipeline.c src/build_commands/debugger.c \
				src/executor/exec_pipeline.c src/executor/pipe_utils.c src/executor/spawn_cmd.c src/executor/wait_utils.c 
OBJ         := $(SRC:.c=.o)
