...
SRC         :=  src/main.c \
                ...
                src/utils/free_allocs.c src/utils/free_split.c src/utils/get_working_dir.c src/utils/print_msh_banner.c src/utils/signal_handling/signal.c	src/utils/env_init.c src/06_builtins/env.c	src/06_builtins/export.c \
				src/06_builtins/builtin_utils.c 
OBJ         := $(SRC:.c=.o)
