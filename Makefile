...
SRC         :=  src/main.c \
                ...
                src/05_collect_heredocs/collect_heredocs.c src/05_collect_heredocs/hd_signal_utils.c src/05_collect_heredocs/hd_tty_utils.c src/05_collect_heredocs/hd_utils.c \
