...
SRC         :=	src/main.c	src/executor/resolve_path.c	src/utils/free_split.c src/executor/execute_external_f.c src/parser/simple_parse.c \
				...
				src/expander/01_expansion.c src/expander/02_expand_status.c src/expander/03_expand_variable.c src/expander/04_expand_utils.c src/expander/05_expand_utils_2.c src/utils/quote_removal.c
OBJ         := $(SRC:.c=.o)
