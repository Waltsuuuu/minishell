...
SRC         :=  src/main/main.c src/main/main_parse.c \
                ...
                src/04_build_cmd_pipeline/build_pipeline.c src/04_build_cmd_pipeline/pipeline_args.c src/04_build_cmd_pipeline/pipeline_exit_free.c src/04_build_cmd_pipeline/pipeline_redirs.c src/04_build_cmd_pipeline/pipeline_utils.c \
                src/05_collect_heredocs/collect_heredocs.c src/05_collect_heredocs/hd_signal_utils.c src/05_collect_heredocs/hd_utils.c src/05_collect_heredocs/hd_input_read_write.c \
				...
				src/utils/count_heredocs.c src/utils/mode_check.c src/utils/tty.c src/06_execute_cmd_pipeline/handle_redirs.c src/06_execute_cmd_pipeline/apply_redirs.c \
				src/debug/pipeline_debugger.c src/debug/tok_debug.c
OBJ         := $(SRC:.c=.o)
