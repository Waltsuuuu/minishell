...
SRC         :=	src/main.c	src/executor/resolve_path.c	src/utils/free_split.c src/parser/simple_parse.c \
				...
				src/build_commands/pipeline_utils.c src/build_commands/pipeline_args.c src/build_commands/pipeline_redirs.c src/parser/token_debugger.c \
				src/utils/free_allocs.c src/utils/get_working_dir.c src/utils/print_msh_banner.c
OBJ         := $(SRC:.c=.o)
