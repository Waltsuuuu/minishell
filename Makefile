...
SRC         :=	src/main.c	src/executor/resolve_path.c	src/utils/free_split.c src/parser/simple_parse.c \
				...
				src/executor/exec_pipeline.c src/executor/pipe_utils.c src/executor/spawn_cmd.c src/executor/wait_utils.c src/build_commands/pipeline_exit_free.c src/build_commands/pipeline_utils.c
OBJ         := $(SRC:.c=.o)
